...
auth_bp.add_url_rule('/verify-email', 'verify_email', AuthController.verify_email, methods=['GET'])
auth_bp.add_url_rule('/resend-verification', 'resend_verification', AuthController.resend_verification, methods=['POST'])